...
export default function Footer() {
  return (
    <footer className="border-b border-amber-500/20 bg-black/30 backdrop-blur-xl supports-[backdrop-filter]:bg-black/80 text-white py-8 md:py-12 border border-amber-500/10 rounded-2xl">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2">
                ...
                <span className="text-gray-300">info@axevisa.com</span>
              </li>
            </ul>
          </div>
        </div>
